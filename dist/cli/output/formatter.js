 ...
 */
export function formatHeader(projectName, filesCount, languages, durationSec) {
 ...
 */
export function formatSectionHeader(emoji, label) {
 ...
 */
export function formatRiskLabel(numericScore) {
    if (numericScore >= 8) {
