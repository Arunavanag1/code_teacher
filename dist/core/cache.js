 ...
 */
export function computeCommitHash(projectPath) {
    try {
 ...
 * @returns 64-character hex string
 */
export async function computeAgentVersion(agentPath) {
 ...
 */
export function computeCacheKey(commitHash, contentHash, agentVersion) {
 ...
 */
export async function computeProjectContentHash(files) {
 ...
 */
export async function getCached(key, cacheDir) {
    try {
 ...
 * @param cacheDir - Absolute path to the cache directory
 */
export async function setCached(key, value, cacheDir) {
    try {
